...
excludes = ["atomicwrites", "attr", "_pytest",
"cffi", "ctypes", "curses",
"dateutil", "distutils", "email", "encoding",
"html", "http", "json", "setuptools", "unittest",
"urllib", "numpy", "pkg_resources", "scipy", "xmlrpc", "pydoc_data"]
packages = ["pygame"]  # nommer les packages utilises

# copier les fichiers non-Python et/ou repertoires et leur contenu:
includefiles = ["cartes", "data","modules"]
...
cible_1 = Executable(script = "interface.py", base=base)
...
# creation du setup
setup(
    name="MacGyver_in_lab",
    version="1.00",
    description="Aidez MacGyver a s'enfuire du labyrinthe",
    author="blingstand",
